...
NUANCE_FAMILLE: dict[str, str] = {
    # extrême gauche
    "EXG": "EXG", "LO": "EXG", "NPA": "EXG", "DXG": "EXG", "FRN": "EXG",
    # France insoumise
    "FI": "LFI", "LFI": "LFI",
    ...
    "SOC": "SOC", "RDG": "SOC", "DVG": "DVG", "PRG": "SOC", "FG": "PCF",
    # écologistes
    "VEC": "ECO", "ECO": "ECO", "EELV": "ECO",
    # centre / présidentiel
    "ENS": "ENS", "REM": "ENS", "MDM": "ENS", "MODEM": "ENS", "HOR": "ENS",
    "DVC": "ENS", "ECG": "ENS", "REN": "ENS",
    "UDI": "UDI", "UC": "UDI",
    # droite
    "LR": "LR", "UMP": "LR", "DVD": "DVD", "DLF": "DVD", "CEN": "UDI",
    # extrême droite
    "RN": "RN", "FN": "RN", "REC": "REC", "UXD": "EXD", "EXD": "EXD",
    "DSV": "EXD",
    # régionalistes / divers / autres
    "REG": "REG", "DIV": "DIV", "AUT": "DIV", "DVD?": "DVD",
    "ALLI": "DIV", "ECOL": "ECO",
}
...
PRESIDENTIELLE_FAMILLE: dict[str, str] = {
    # 2012
    "MELENCHON": "LFI", "JOLY": "ECO", "HOLLANDE": "SOC", "POUTOU": "EXG",
    "ARTHAUD": "EXG", "BAYROU": "ENS", "SARKOZY": "LR", "DUPONT-AIGNAN": "DVD",
    "LE PEN": "RN", "CHEMINADE": "DIV",
    # 2017
    "HAMON": "SOC", "FILLON": "LR", "MACRON": "ENS", "ASSELINEAU": "DIV",
    "LASSALLE": "DIV", "FILLON FRANCOIS": "LR",
    # 2022
    "ROUSSEL": "PCF", "JADOT": "ECO", "HIDALGO": "SOC", "PECRESSE": "LR",
    "ZEMMOUR": "REC",
}

# --- famille -> bloc6 (recomposition de la prez) -----------------------------
FAMILLE_BLOC6: dict[str, str] = {
    "EXG": "LFI-PCF-EXG", "LFI": "LFI-PCF-EXG", "PCF": "LFI-PCF-EXG",
    "UG": "LFI-PCF-EXG",  # coalition de gauche, rattachée au pôle insoumis/gauche
    "SOC": "PS-EELV", "ECO": "PS-EELV", "DVG": "PS-EELV",
    "ENS": "MoDem-EM", "UDI": "MoDem-EM",
    "LR": "LR-DVD", "DVD": "LR-DVD",
    "RN": "RN-EXD", "REC": "RN-EXD", "EXD": "RN-EXD",
    "REG": "Autres", "DIV": "Autres",
}

# --- famille -> tripartition (3 blocs de la prez) ----------------------------
FAMILLE_TRIPARTITION: dict[str, str] = {
    "EXG": "social_ecologique", "LFI": "social_ecologique", "PCF": "social_ecologique",
    "UG": "social_ecologique", "SOC": "social_ecologique", "ECO": "social_ecologique",
    "DVG": "social_ecologique",
    "ENS": "liberal_progressiste", "UDI": "liberal_progressiste",
    "LR": "national_patriote", "DVD": "national_patriote",
    "RN": "national_patriote", "REC": "national_patriote", "EXD": "national_patriote",
    "REG": "autres", "DIV": "autres",
}

BLOC6_ORDRE = ["LFI-PCF-EXG", "PS-EELV", "MoDem-EM", "LR-DVD", "RN-EXD", "Autres"]
TRIPARTITION_ORDRE = ["social_ecologique", "liberal_progressiste", "national_patriote", "autres"]
