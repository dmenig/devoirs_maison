...
function adminPanel(o){ const a=o&&o.adm; if(!a)return ""; const fr=window.__adminFr||{};
  ...
  if(a.maire){ const sub=[a.csp||"",a.maire_age!=null?`${a.maire_age} ans`:""].filter(Boolean).join(" · ");
    h+=exp(sec("Maire en exercice · 2026")+
  ...
  if(a.ageh&&a.ageh.some(v=>v!=null)){
    ...
    h+=exp(sec("Pyramide des âges · 2021")+`<div class="pyr"><div class="pyrhead"><span>◀ Hommes</span><span>Femmes ▶</span></div>${rows}</div>`,
  ...
  if(a.prop!=null||a.loc!=null) h+=exp(sec("Logement · statut d'occupation · 2021")+
  ...
  if(a.tr&&a.tr.some(v=>v!=null)) h+=exp(sec("Déplacements domicile-travail · 2021")+
  ...
  if(a.mig&&a.mig.some(v=>v!=null)) h+=exp(sec("Renouvellement de population · 2021")+
